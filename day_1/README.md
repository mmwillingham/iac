...
```
oc login ...
git clone https://github.com/NCDHHS-Enterprise/cwis-infra
git checkout feature-cwis-887-instructions
cd cwis-infra
oc apply -k app/openshift-automation/day1/gitops-operator/overlays/latest
oc apply -k app/openshift-automation/day1/master-apps
```
...
# Specific version
oc apply -k app/openshift-automation/day1/gitops-operator/overlays/gitops-1.12

# Latest version
oc apply -k app/openshift-automation/day1/gitops-operator/overlays/latest

# DELETE
# oc delete -k app/openshift-automation/day1/gitops-operator/overlays/latest
...
export URL="https://github.com/NCDHHS-Enterprise/cwis-infra"
...
# DELETE
# oc delete -k app/openshift-automation/day1/master-apps
```
